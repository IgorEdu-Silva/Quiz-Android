...
public class quizMathematics extends AppCompatActivity {
    ...
    private final int[] correctAnswers = {0, 0, 2, 0, 0, 0, 1, 2, 2};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_mathematics);

        Button btnBack = findViewById(R.id.btnBack);
        btnBack.setOnClickListener(v -> {
            Intent intent = new Intent(quizMathematics.this, SelectGame.class);
        ...
        questions = getResources().getStringArray(R.array.math_questions);
        answers = new String[][]{
                getResources().getStringArray(R.array.math_answers_1),
                getResources().getStringArray(R.array.math_answers_2),
                getResources().getStringArray(R.array.math_answers_3),
                getResources().getStringArray(R.array.math_answers_4),
                getResources().getStringArray(R.array.math_answers_5),
                getResources().getStringArray(R.array.math_answers_6),
                getResources().getStringArray(R.array.math_answers_7),
                getResources().getStringArray(R.array.math_answers_8),
                getResources().getStringArray(R.array.math_answers_9),
                getResources().getStringArray(R.array.math_answers_10)
        };
