...
public class quizEntertainment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions = getResources().getStringArray(R.array.entertainment_questions);
        if (questions != null) {
        ...
        questions = getResources().getStringArray(R.array.entertainment_questions);
        answers = new String[][]{
                getResources().getStringArray(R.array.entertainment_answers_1),
                getResources().getStringArray(R.array.entertainment_answers_2),
                getResources().getStringArray(R.array.entertainment_answers_3),
                getResources().getStringArray(R.array.entertainment_answers_4),
                getResources().getStringArray(R.array.entertainment_answers_5),
                getResources().getStringArray(R.array.entertainment_answers_6),
                getResources().getStringArray(R.array.entertainment_answers_7),
                getResources().getStringArray(R.array.entertainment_answers_8),
                getResources().getStringArray(R.array.entertainment_answers_9),
                getResources().getStringArray(R.array.entertainment_answers_10)
        };
